...
Use this skill when a lecture, workshop, training, or talk should become a clean Markdown-first presentation.
...
2. Expand into `references/templates/lecture-deck.md`.
3. Refine with `references/checklists/slide-quality.md`.
4. Finish delivery prep with `references/checklists/delivery-readiness.md`.
